...
public class Superstructure {
  ...
  private enum scoringModeState{Amp, Speaker};
  ...
  public Superstructure(MAXSwerve drivebase, Intake intake, Outtake outtake, Climb climb) {
    ...
    noteDetected.onTrue(
      Commands.sequence(
        ...
        endUpInRightSpot()
      ).withInterruptBehavior(InterruptionBehavior.kCancelIncoming).withTimeout(10)
    );
  ...
  private Command runPath(String pathName, boolean isBlue, boolean isFirstPath) {
    ...
    Command setPoseCommand = Commands.either(
    ...
    Command swerveCommand = Choreo.choreoSwerveCommand(
            ...
            (ChassisSpeeds speeds) ->
                drivebase.runChassisSpeeds(speeds),
